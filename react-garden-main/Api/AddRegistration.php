...
if (
    ...
    $check = mysqli_query($db_conn, "SELECT* FROM admin WHERE email = '$email'");
    if (mysqli_num_rows($check) > 0) {
        ...
        $result = mysqli_query($db_conn, "INSERT INTO admin (name,email, password) VALUES ('$name', '$email','$pswd ')");

...
<div className="container-fluid p-0 wow fadeIn" data-wow-delay="0.1s">
        ...
        <div className="container">
            <div className="row g-5 align-items-end">
                <div className="col-lg-3 col-md-5 wow fadeInUp" data-wow-delay="0.1s">
                    <img className="img-fluid rounded" data-wow-delay="0.1s" src="assets/img/about.jpg"/>
                </div>
    ...
    <div className="container-fluid facts my-5 py-5" data-parallax="scroll" data-image-src="assets/img/carousel-1.jpg">
    ...
    <div className="container-fluid quote my-5 py-5" data-parallax="scroll" data-image-src="assets/img/carousel-2.jpg">
        <div className="container py-5">
            <div className="row justify-content-center">
                <div className="col-lg-7">
                ...
                <div className="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.1s">
                    <div className="portfolio-inner rounded">
                        ...
                        <div className="portfolio-text">
                            ...
                            <div className="d-flex">
                                <a className="btn btn-lg-square rounded-circle mx-2" href="assets/img/service-1.jpg" data-lightbox="portfolio"><i className="fa fa-eye"></i></a>
                ...
                <div className="col-lg-4 col-md-6 portfolio-item second wow fadeInUp" data-wow-delay="0.3s">
                    <div className="portfolio-inner rounded">
                        ...
                        <div className="portfolio-text">
                            ...
                            <div className="d-flex">
                                <a className="btn btn-lg-square rounded-circle mx-2" href="assets/img/service-2.jpg" data-lightbox="portfolio"><i className="fa fa-eye"></i></a>
                                <a className="btn btn-lg-square rounded-circle mx-2" href=""><i className="fa fa-link"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.5s">
                    <div className="portfolio-inner rounded">
                        ...
                        <div className="portfolio-text">
                            ...
                            <div className="d-flex">
                                <a className="btn btn-lg-square rounded-circle mx-2" href="assets/img/service-3.jpg" data-lightbox="portfolio"><i className="fa fa-eye"></i></a>
                                <a className="btn btn-lg-square rounded-circle mx-2" href=""><i className="fa fa-link"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-lg-4 col-md-6 portfolio-item second wow fadeInUp" data-wow-delay="0.1s">
                    <div className="portfolio-inner rounded">
                        ...
                        <div className="portfolio-text">
                            ...
                            <div className="d-flex">
                                <a className="btn btn-lg-square rounded-circle mx-2" href="assets/img/service-4.jpg" data-lightbox="portfolio"><i className="fa fa-eye"></i></a>
                                <a className="btn btn-lg-square rounded-circle mx-2" href=""><i className="fa fa-link"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.3s">
                    <div className="portfolio-inner rounded">
                        ...
                        <div className="portfolio-text">
                            ...
                            <div className="d-flex">
                                <a className="btn btn-lg-square rounded-circle mx-2" href="assets/img/service-5.jpg" data-lightbox="portfolio"><i className="fa fa-eye"></i></a>
                                <a className="btn btn-lg-square rounded-circle mx-2" href=""><i className="fa fa-link"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-lg-4 col-md-6 portfolio-item second wow fadeInUp" data-wow-delay="0.5s">
                    <div className="portfolio-inner rounded">
                        ...
                        <div className="portfolio-text">
                            ...
                            <div className="d-flex">
                                <a className="btn btn-lg-square rounded-circle mx-2" href="assets/img/service-6.jpg" data-lightbox="portfolio"><i className="fa fa-eye"></i></a>
                                <a className="btn btn-lg-square rounded-circle mx-2" href=""><i className="fa fa-link"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-lg-7 wow fadeInUp" data-wow-delay="0.5s">
                    <div className="owl-carousel testimonial-carousel">
                        <div className="testimonial-item">
                            <img className="img-fluid rounded mb-3" src="assets/img/testimonial-1.jpg" alt=""/>
                        ...
                        <div className="testimonial-item">
                            <img className="img-fluid rounded mb-3" src="assets/img/testimonial-2.jpg" alt=""/>
                            <p className="fs-5">Dolores sed duo clita tempor justo dolor et stet lorem kasd labore dolore lorem ipsum. At lorem lorem magna ut et, nonumy et labore et tempor diam tempor erat.</p>
                            <h4>Client Name</h4>
                            <span>Profession</span>
                        </div>
